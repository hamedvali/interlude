...
print("  hooks registered: UserPromptSubmit, PreToolUse, PostToolUse, PostToolUseFailure, Stop, Notification")
PYEOF
...
say ""
say "Auto-update is on: Interlude checks $REPO@$REF in the background and applies"
say "new versions itself (with an in-app toast). Update now: interlude update"
say "Turn it off: interlude update off   (or set INTERLUDE_NO_UPDATE=1)"
